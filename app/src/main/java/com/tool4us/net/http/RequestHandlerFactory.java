...
public class RequestHandlerFactory
{
    ...
    private void initClasseMap(String packageName)
    {
        ...
        Set<Class<? extends HTTPServiceHandle>> allClasses
            = reflections.getSubTypesOf(HTTPServiceHandle.class);

        for(Class<? extends HTTPServiceHandle> clazz : allClasses)
        {           
    ...
    public HTTPServiceHandle getRquestClazz(String uri) throws Exception
    {
        ...
        return (HTTPServiceHandle) clazz.newInstance();
    }
}
